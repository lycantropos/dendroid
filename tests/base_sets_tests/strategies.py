...
empty_sets = strategies.builds(
    to_set, factories, empty_value_sequence_with_order_strategy
)
sets = strategies.builds(to_set, factories, value_sequence_with_order_strategy)
sets_with_none_orders = strategies.builds(
    to_set, factories, value_sequence_with_none_order_strategy
)
sets_with_two_or_more_values = strategies.builds(
    to_set, factories, two_or_more_values_with_order_strategy
...
non_empty_sets = strategies.builds(
    to_set, factories, non_empty_value_sequence_with_order_strategy
)
...
sets_with_values = strategies.builds(
    to_set_with_value, factories, non_empty_value_sequence_with_order_strategy
)
empty_sets_with_values = strategies.builds(
    to_set_with_value, factories, single_value_with_order_strategy
)
non_empty_sets_with_values = strategies.builds(
    to_set_with_value, factories, two_or_more_values_with_order_strategy
)
...
sets_with_values_pairs = strategies.builds(
    to_set_with_values_pair, factories, two_or_more_values_with_order_strategy
)
...
def to_sets_tuple(
    ...
    value_sequences, order = value_sequences_pair_with_order
    return tuple(
        factory(*values_list, key=order) for values_list in value_sequences
    )
...
def to_sets_pair_with_value(
    ...
    (first_values, second_values), order = value_sequences_pair_with_order
