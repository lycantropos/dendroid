...
def test_antisymmetry(keys_views_pair: KeysViewsPair) -> None:
    ...
    assert equivalence(first_keys_view <= second_keys_view <= first_keys_view,
...
@given(strategies.keys_views_pairs)
def test_connection_with_lower_than(keys_views_pair: KeysViewsPair) -> None:
    first_keys_view, second_keys_view = keys_views_pair
...
@given(strategies.keys_views_pairs)
def test_connection_with_greater_than_or_equals(keys_views_pair: KeysViewsPair
                                                ) -> None:
    first_keys_view, second_keys_view = keys_views_pair
