...
@given(strategies.keys_views_pairs)
def test_expressing_intersection_as_difference(keys_views_pair: KeysViewsPair
                                               ) -> None:
    left_keys_view, right_keys_view = keys_views_pair
...
def test_difference_subtrahend(keys_views_triplet: KeysViewsTriplet) -> None:
...
@given(strategies.keys_views_triplets)
def test_intersection_minuend(keys_views_triplet: KeysViewsTriplet) -> None:
    left_keys_view, mid_tree, right_keys_view = keys_views_triplet
...
@given(strategies.keys_views_triplets)
def test_intersection_subtrahend(keys_views_triplet: KeysViewsTriplet) -> None:
    left_keys_view, mid_tree, right_keys_view = keys_views_triplet
...
@given(strategies.keys_views_triplets)
def test_union_subtrahend(keys_views_triplet: KeysViewsTriplet) -> None:
    left_keys_view, mid_tree, right_keys_view = keys_views_triplet
...
@given(strategies.keys_views_pairs)
def test_connection_with_subkeys_view_relation(keys_views_pair: KeysViewsPair
                                               ) -> None:
    left_keys_view, right_keys_view = keys_views_pair
